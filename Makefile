...
#    Updated: 2018/11/29 19:44:34 by pscott           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
NEWS	:= ft_printf.c convert.c specs.c ft_atoi_move.c exit.c parse_struct.c ft_strcat_free.c format_int.c ft_uitoa.c
