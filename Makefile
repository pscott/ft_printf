...
#    Updated: 2018/12/15 13:15:39 by pscott           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
NEWS	:= ft_printf.c converters.c ft_atoi_move.c exit.c parse_struct.c ft_strcat_free.c format_int.c ft_uitoa.c get_len.c getters.c utils.c spec_init.c format_char.c format_unsigned.c format_string.c get_ulen.c format_lint.c format_llint.c format_num.c ft_hitoa.c ft_hhitoa.c
